...
class Node{
    public:
        ...
        // Deque of elements containing pointers to the neighbours of the node
...
int main(/*int argc, char const *argv[]*/){
    ...
    for(int i=0;i<m;i++){
        int u = (i),v = (i+1)%6;
        graph.nodes.at(u)->addNeighbour(graph.nodes.at(v));
    }
    ...
    //Viewing the values of all nodes and their neighbours
